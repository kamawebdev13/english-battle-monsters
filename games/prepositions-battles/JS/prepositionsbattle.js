...
const questionsLevelOne = [
  {
    src: "./images/questions/office-coffee-interior-design__01.webp",
  ...
  {
    src: "./images/questions/woman-walking-in-Madrid__02.webp",
  ...
  {
    src: "./images/questions/woman-checking-her-watch__03.webp",
  ...
  {
    src: "./images/questions/cat-sitting-in-a-box__04.webp",
  ...
  {
    src: "./images/questions/man-putting-his-phone-into-his-pocket__05.webp",
...
const questionsLevelTwo = [
  {
    src: "./images/questions/level2-question-01.webp",
  ...
  {
    src: "./images/questions/level2-question-02.webp",
  ...
  {
    src: "./images/questions/level2-question-03.webp",
  ...
  {
    src: "./images/questions/level2-question-04.webp",
  ...
  {
    src: "./images/questions/level2-question-05.webp",
...
const levelConfigs = {
  1: {
    ...
    timePerQuestion: 10,
    sentenceAudios: [
      './sounds/questions/question-01.mp3',
      './sounds/questions/question-02.mp3',
      './sounds/questions/question-03.mp3',
      './sounds/questions/question-04.mp3',
      './sounds/questions/question-05.mp3'
    ]
  },
  2: {
    ...
    timePerQuestion: 8,
    sentenceAudios: [
      './sounds/questions/level2-question-01.mp3',
      './sounds/questions/level2-question-02.mp3',
      './sounds/questions/level2-question-03.mp3',
      './sounds/questions/level2-question-04.mp3',
      './sounds/questions/level2-question-05.mp3'
    ]
  }
}
...
const initGame = () => {
  ...
  window.addEventListener('DOMContentLoaded', () => {
    ...
    const handlePlayClick = async (e) => {
      ...
      levelVoiceAudios = {
        1: new Audio('./sounds/actions/level-start.mp3'),
        2: new Audio('./sounds/actions/level-two.mp3')
      }
    ...
    const startLevelOne = () => {
      ...
      imagePrepoMonster.src = "./images/monsters/webp/prepo-battle.webp"
      ...
      imageMeanerPrepoMonster.src = "./images/monsters/webp/meanerprepo-battle.webp"
      imageMeanerPrepoMonster.alt = "Enemy monster"
      /*TAMAÑO INICIAL DE LOS SPRITES Y UNCION CONTROL DE TAMAÑO*/
      prepoGrowth = 0
      meanerGrowth = 0
      applyMonsterScale()
    ...
    const updatePrepoState = (state) => {
      if (state === "happy") {
        prepoPoints++
        prepoGrowth += 0.1
        imagePrepoMonster.src = "./images/monsters/webp/prepo-win.webp"
      ...
      if (state === "sad") {
        prepoPoints--
        prepoGrowth -= 0.1
        imagePrepoMonster.src = "./images/monsters/webp/prepo-lose.webp"
    ...
    const updateMeanerState = (state) => {
      if (state === "happy") {
        ...
        imageMeanerPrepoMonster.src =
          "./images/monsters/webp/meanerprepo-win.webp"
        soundMonsterGrow.currentTime = 0
        soundMonsterGrow.play()
      }
      ...
      if (state === "sad") {
        ...
        meanerGrowth -= 0.1
        imageMeanerPrepoMonster.src =
          "./images/monsters/webp/meanerprepo-lose.webp"
        soundMonsterShrink.currentTime = 0
        soundMonsterShrink.play()
      }
    ...
    const endLevelOne = () => {
      ...
      if (playerWon) {
        ...
        imagePrepoMonster.src = "./images/monsters/webp/prepo-win.webp"
        imageMeanerPrepoMonster.src = "./images/monsters/webp/meanerprepo-lose.webp"
    ...
    `
        ...
        imagePrepoMonster.src = "./images/monsters/webp/prepo-lose.webp"
        imageMeanerPrepoMonster.src = "./images/monsters/webp/meanerprepo-win.webp"
